...
const Login = () => {
    ...
    return (
        ...
        <form className="form mt-3 w-75 mx-auto" onSubmit={handleSubmit} action="#">
        ...
        <input type="password" placeholder="Type your password" className="form-control input no-outline" name="confirm" onChange={changevalue} value={formData.confirmpass}/>
    </div>
